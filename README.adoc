...
image::relatorio.png[]
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/babivduarte/TDD-SistemaBancario/maven[GitHub Workflow Status]
